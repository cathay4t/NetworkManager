...
pub struct NmUuid(u128);

impl AsRef<u128> for NmUuid {
    fn as_ref(&self) -> &u128 {
        &self.0
    }
}

impl std::ops::Deref for NmUuid {
    type Target = u128;
...
impl std::ops::DerefMut for NmUuid {
    fn deref_mut(&mut self) -> &mut u128 {
        &mut self.0
    }
}

impl std::fmt::Display for NmUuid {
...
impl<'de> Deserialize<'de> for NmUuid {
