...
use crate::{
    ErrorKind, Interfaces, MergedRoutes, NmError, RouteEntry, RouteType, Routes,
};
...
) -> Result<nispor::RouteConf, NmError> {
...
fn validate_routes(merged_routes: &MergedRoutes) -> Result<(), NmError> {
