...
use crate::{ErrorKind, Interfaces, JsonDisplay, NmError, NmstateInterface};
...
impl RouteEntry {
    ...
    pub(crate) fn sanitize(&mut self) -> Result<(), NmError> {
...
// for unicast route
fn validate_route_dst(route: &RouteEntry) -> Result<(), NmError> {
