...
use crate::{
    ...
    MergedInterface, MergedInterfaces, NmError, NmstateInterface, OvsInterface,
};
...
impl MergedInterfaces {
    ...
    fn validate_controller_not_in_port_list(&self) -> Result<(), NmError> {
    ...
    fn validate_controller_in_other_port_list(&self) -> Result<(), NmError> {
    ...
    fn handle_changed_ports(&mut self) -> Result<(), NmError> {
    ...
    fn check_overbook_ports(&self) -> Result<(), NmError> {
    ...
    fn check_infiniband_as_ports(&self) -> Result<(), NmError> {
