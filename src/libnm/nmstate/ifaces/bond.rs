...
impl BondInterface {
    ...
    fn check_overlap_queue_id(&self) -> Result<(), NmError> {
...
impl BondOptions {
    ...
    fn validate_ad_actor_system_mac_address(&self) -> Result<(), NmError> {
    ...
    fn validate_miimon_and_arp_interval(&self) -> Result<(), NmError> {
    ...
    fn validate_lacp_opts(&self, mode: BondMode) -> Result<(), NmError> {
